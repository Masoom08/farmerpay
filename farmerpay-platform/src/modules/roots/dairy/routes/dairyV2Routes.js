...
// --------- Dairy PoP Engine (Phase 6.1) ---------
const popEngineCtrl = require('../controllers/dairyPopEngineController');
router.get('/herds/:herdId/pop-comparison', popEngineCtrl.getPopComparison);
router.get('/herds/:herdId/compliance-score', popEngineCtrl.getComplianceScore);
router.get('/herds/:herdId/alerts', popEngineCtrl.getAlerts);
router.get('/animals/:animalId/yield-variance', popEngineCtrl.getYieldVariance);
router.get('/herds/:herdId/reproductive-efficiency', popEngineCtrl.getReproductiveEfficiency);
