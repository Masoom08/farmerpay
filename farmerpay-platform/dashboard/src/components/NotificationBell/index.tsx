...
/**
 * NotificationBell — Banker dashboard notification bell (H3 — Spec §6.3).
 *
 * Shows unread count badge. Clicking opens a dropdown with recent notifications.
 * Events: trust.score.dropped.50, cibil.flag.raised → shown as alerts.
 */
...
export interface NotificationBellProps {
  /** Fetch notifications from API. If not provided, uses empty state. */
